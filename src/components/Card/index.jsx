...
//karttaki üründen kaç tane olduğunu kontrol etmek için
  const found = basket.filter((i) => i.name === item.name)
  const amount = found.length

// handleReset fonksiyonu, sepetten bir ürünü çıkarmak için kullanılır
// i.name === item.name koşuluyla eşleşen eleman sepetten çıkarılır
  const handleReset = () => {
